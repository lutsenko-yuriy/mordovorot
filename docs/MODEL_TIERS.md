...
| `note` | RAPID | MECHANICAL | Capture a quick observation into the knowledge base |
| `checkup` | THOROUGH | ARCHITECTURAL | Codebase-wide, non-mechanical quality dimensions |
| `debrief` | FOCUSED | ARCHITECTURAL | Post-ticket retrospective synthesis |
...
| `research` | FOCUSED | ARCHITECTURAL | Thesis/antithesis/synthesis literature research |
| `draft-scenarios` | FOCUSED | TACTICAL | Write red integration test stubs from a ticket spec |
