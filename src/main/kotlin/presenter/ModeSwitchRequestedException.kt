 ...
 * [ModeSwitcherImpl.switchTo] the same way [ExitRequestedException] signals a session should
 * end. Unwinds whichever `View.play()` is running (`view.ViewImpl`'s console loop,
