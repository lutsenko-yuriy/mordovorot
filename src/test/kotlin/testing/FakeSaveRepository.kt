 ...
 * Used to exercise [viewmodel.ViewModelImpl]'s save/load delegation without touching disk.
 */
class FakeSaveRepository(
     ...
     *  validation (e.g. [viewmodel.ViewModelImpl.exitGame]'s re-prompt loop) don't need the
