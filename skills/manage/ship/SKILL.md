...
### Added / Changed / Fixed
- GH-XX: <one-line summary of what changed>
```
...
git commit -m "chore: release GH-XX, bump version to X.Y.Z"
git push
```
...
After reporting, propose: *"Want to run `/debrief GH-XX` to capture what you learned from this ticket?"* (optional — do not block on it)
