...
The project management tool is **GitHub Issues**. The Git host is **GitHub**. The issue identifier prefix is **GH**.
...
> "No approved plan found on GH-XX. Invoke the `plan` skill to produce and approve a plan before implementation can begin."
...
Branch naming: `feature/GH-XX-<short-description>` (2–4 words, kebab-case).

- If already on the correct branch, continue.
- Otherwise: `git checkout -b feature/GH-XX-<short-description>`
...
git commit -m "style: apply formatter (GH-XX)"
```
